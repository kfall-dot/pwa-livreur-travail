...
export const css = {
  ...
  sidebarNav: { display: 'flex', flexDirection: 'column', flex: 1, gap: 2, padding: '0 12px' } as CSSProperties,
  sidebarSection: {
    fontSize: 10,
    fontWeight: 600,
  ...
  sidebarIcon: { width: 20, textAlign: 'center' as const, fontSize: 16, flexShrink: 0 } as CSSProperties,
  sidebarBadge: {
    marginLeft: 'auto',
    background: '#22c55e',
    color: '#fff',
  ...
  sidebarUserInfo: { flex: 1 } as CSSProperties,
