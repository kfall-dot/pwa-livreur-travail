...
function AuthFooter() {
  return (
    <footer className="auth-shell__footer">
      <span className="auth-shell__footer-proof">
        <span className="auth-shell__footer-shield" aria-hidden="true">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 2l7 3v6c0 5-3.5 9.4-7 11-3.5-1.6-7-6-7-11V5l7-3z" />
          </svg>
          <span className="auth-shell__footer-shield-check">✓</span>
        </span>
        {BRAND_FOOTER}
      </span>
      <span className="auth-shell__footer-flag">Côte d&apos;Ivoire</span>
    </footer>
  )
}
