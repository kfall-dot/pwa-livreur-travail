...
**Périmètre :** pilote BTP — achats chantier, livraison, stock (phases)  
...
| **Extension Achats BTP** | **Prototype local** — non déployé | WhatsApp → EB → BC → livraison |
...
| **1 — Achats + livraison** | WhatsApp → EB → approbations → BC → tournée auto ; exports SA (EB, registre) | 8–12 semaines | Meta Business, budget |
| **1b — Consolidation** | Multi-BC → 1 tournée | +2–4 semaines | Volume BC observé |
| **2 — Stock S0–S1** | Entrée auto ; tableau + seuils | +4 semaines | Livraisons stables |
| **3 — Stock S2** | EB anticipée ; WhatsApp stock bas | +4 semaines | Seuils calibrés |
| **4 — Extension** | Multi-chantiers ; voix/photo production ; recap registre auto | Selon retour | Bilan pilote |

### 7.2 Ce qui est déjà prêt (prototype — non prod)

- Schéma données achats, API, onglet manager **Achats chantier**  
- Simulation WhatsApp (tests)  
- Pont livraison BC → tournée (manuel puis règles formalisées)  
- **Non déployé** — en attente validation board et infra (Meta, DB)  

### 7.3 Hors calendrier immédiat
...
| [BTP-SYNTHESE-EXECUTIVE-DIRECTION.md](./BTP-SYNTHESE-EXECUTIVE-DIRECTION.md) | **Synthèse exécutive direction** — document de décision |
