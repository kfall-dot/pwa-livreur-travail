...
var worker_default = {
  async fetch(request) {
    ...
    return Response.json({
      ok: false,
      message: "L'API Express de pwa-livreur est h\xE9berg\xE9e sur Netlify, pas sur ce worker (voir server/index.ts).",
      path: url.pathname
    }, { status: 404 });
  },
  scheduled() {
...
// .wrangler/tmp/bundle-exUazM/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-exUazM/middleware-loader.entry.ts
