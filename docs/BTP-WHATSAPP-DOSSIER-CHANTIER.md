...
- [BTP-SYNTHESE-EXECUTIVE-DIRECTION.md](./BTP-SYNTHESE-EXECUTIVE-DIRECTION.md) — CDC F01–F07, F09 (WhatsApp = F05 / F07)  
...
**CDC :** **F07** (saisie terrain) et **F05** (avancement physique) passent par ce canal — pas une 3ᵉ application. **F08** et **F10** hors TraceO.
